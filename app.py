...
class StartAuthHandler(tornado.web.RequestHandler):
	...
	def get(self):
		...
		callback = path + "/code"
		payload = {"client_id" : Client_ID, "scope" : r"alexa%3aall%20profile", "scope_data" : sd, "response_type" : "code", "redirect_uri" : callback }
...
def main():
	...
	http_server = tornado.httpserver.HTTPServer(application, ssl_options={
		...
		'keyfile' : '/etc/letsencrypt/keys/0000_key-letsencrypt.pem'	
	})
